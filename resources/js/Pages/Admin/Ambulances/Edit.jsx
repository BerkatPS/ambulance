...
export default function AmbulanceEdit({ auth, ambulance, ambulanceTypes, ambulanceStations }) {
    // Set up form using Inertia's useForm with initial data from ambulance
    const { data, setData, patch, processing, errors, reset } = useForm({
        ...
        ambulance_station_id: ambulance.ambulance_station_id || '',
        status: ambulance.status || 'available',
        last_maintenance_date: formatDateForInput(ambulance.last_maintenance_date) || '',
        next_maintenance_date: formatDateForInput(ambulance.next_maintenance_date) || '',
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        patch(route('admin.ambulances.update', ambulance.id));
    };
    
    return (
        <AdminDashboardLayout user={auth.user} title={`Edit Ambulans: ${ambulance.registration_number}`}>
            <Head title={`Edit Ambulans: ${ambulance.registration_number}`} />
            ...
            <div className="space-y-6">
                ...
                <nav className="flex" aria-label="Breadcrumb">
                    <ol className="flex items-center space-x-4">
                        ...
                        <li>
                            <div className="flex items-center">
                                <ChevronRightIcon className="h-5 w-5 flex-shrink-0 text-slate-400" aria-hidden="true" />
                                <span className="ml-4 text-slate-500 font-medium">Edit</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <div>
                        <h1 className="text-2xl font-semibold text-gray-900">Edit Ambulans: {ambulance.registration_number}</h1>
                        <p className="mt-2 text-sm text-gray-700">
                            Perbarui detail dan informasi ambulans.
                        </p>
                    </div>
                </div>
                        ...
                        <div className="space-y-6 p-5 sm:p-6">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-sm text-gray-500">
                                    Perbarui detail dasar dari kendaraan ambulans.
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <TextInput
                                        ...
                                        type="date"
                                        className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                                        value={formatDateForInput(data.last_maintenance_date)}
                                ...
                                <div>
                                    ...
                                    <TextInput
                                        ...
                                        type="date"
                                        className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                                        value={formatDateForInput(data.next_maintenance_date)}
